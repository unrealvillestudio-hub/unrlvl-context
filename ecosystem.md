...
> **Nota de sincronización — ACTUALIZA 2026-09-20 (`ecosystem.json` v2026-09-17-v1 → **v2026-09-20-v1**).**
> **Este archivo se SINCRONIZA, no se regenera, y el cuerpo previo queda íntegro.**
>
> **Nodos que cambiaron en el JSON, y NADA MÁS:**
>
> 1. **`_meta`** — `version` → `2026-09-20-v1`, `previous` → `2026-09-17-v1`, y `2026-09-17-v1` entra
>    **al tope** de `previous_chain`. Ninguna entrada de la cadena se pierde.
