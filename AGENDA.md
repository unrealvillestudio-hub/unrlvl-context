...
> la lectura de un buzón de cliente. Se conserva **sólo el hecho verificable de forma independiente**
> —la consulta a `list_projects`—, que es además la única vía por la que este ítem es anotable._
...
> entrega observado leyendo un buzón de cliente. Se conserva lo comprobable desde fuera, y lo demás
