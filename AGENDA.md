...
1. 🔐 **SEGURIDAD — `media-store` lleva un secreto cableado** como valor por defecto de
...
2. 🔴 **LOS ÁLAMOS** — la decisión de mayor impacto financiero de la operadora, **sin tomar** desde
   el 2026-09-19. 329 unidades, **$2,152/mes** de pérdida, más que el margen de Luxor y Venezia juntos.
