...
| `DELIVERY_AND_VERIFICATION_RULE.md` | `protocols/DELIVERY_AND_VERIFICATION_RULE.md` | Regla inviolable: bloques con destinatario declarado y marca visual por superficie (para que Sam lea, no para que CC ejecute), idioma ES/EN neutro sin voseo, etiqueta de evidencia, panel de carga verificada y las cuatro QA (HRD RULES). | Claude + Sam, bajo PR |
